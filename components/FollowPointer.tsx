...
//         >
//             <path d="M14.082 2.182a.5.5 0 0 1 .103.557L8.528 15.467a.5.5 0 0 1-.917-.007L5.
    ...
    return (
        ...
        >
            <svg
                ...
                className="h-6 w-6 transform -rotate-[70deg] -translate-x-[8px] -translate-y-[8px]"
                height="1em"
                width="1em"
                xmlns='http://www.w3.org/2000/svg'
            >
            ...
            <motion.div
                ...
                className="px-2 py-1 bg-neutral-200 text-black font-bold whitespace-nowrap min-w-max text-xs rounded-full"
            >
                {info?.name || info.email}
            </motion.div>
        </motion.div>
